...
<html>
    ...
    <body>
        ...
        <form action="${url}/cham-soc-da" class="trang-chm-sc-da">
...
<!--            <div class="trang-chm-sc-da-child"></div>
            ...
            <div class="trang-chm-sc-da-item"></div>
            <div class="navbar">
                <div class="bag" id="bagContainer">
                    <img class="bag-1-icon" alt="" src="/J2EE/view/img/images/bag.png" />
                </div>
                <div class="login">
