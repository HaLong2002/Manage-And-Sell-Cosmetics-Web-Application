...
<html>
    ...
    <body>
        ...
        <form action="${url}/my-pham-chuc-nang" class="trang-m-phm-chc-nng">
<!--            <div class="trang-m-phm-chc-nng-child"></div>
            <div class="danh-muc-san-pham">
                <button formaction="${url}/chong-nang" class="chng-nng">
                    <div class="m-phm-chc">CHỐNG NẮNG</div>
                </button>
                <div class="m-phm-chc-nng">MỸ PHẨM CHỨC NĂNG</div>
            ...
            <div class="trang-m-phm-chc-nng-item"></div>
            <div class="navbar">
